...
def test_normal_transaction():
    ...
    normal_features = [
        0.1, -0.5, 0.3, -0.2, 0.8, -0.1, 0.4, -0.3, 0.2, -0.6,
        0.7, -0.4, 0.1, 0.5, -0.8, 0.3, -0.2, 0.6, -0.1, 0.4,
        -0.7, 0.2, 0.9, -0.3, 0.1, 0.5, -0.6, 0.8, -0.4, 0.2
    ]
...
def test_fraudulent_transaction():
    ...
    fraud_features = [
        5.2, -8.1, 12.3, -15.7, 20.4, -6.8, 9.1, -11.2, 7.5, -13.9,
        18.6, -22.3, 14.7, -9.8, 25.1, -16.4, 11.9, -19.2, 8.3, -12.6,
        21.7, -14.5, 16.8, -23.1, 10.4, -18.7, 13.2, -20.9, 15.6, -11.8
    ]
